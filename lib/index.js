...
class TranslateManager {
    constructor(_storage, maxLen = 5000, opts = { to: 'auto', from: 'auto' }) {
     ...
     */
    async translate(text, { to = this.opts.to, from = this.opts.from } = this.opts) {
     ...
     */
    link(text, { to = this.opts.to, from = this.opts.from } = this.opts) {
        try {
